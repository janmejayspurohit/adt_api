...
describe("User controller", () => {
  test("allUsers", async () => {
    ...
    const spyUserFindAndCountAll = jest.spyOn(User, "findAndCountAll").mockImplementation(() => Promise.resolve([]));
    ...
    expect(successResponse).toHaveBeenCalledWith(expect.any(Object), expect.any(Object), expect.any(Object));
